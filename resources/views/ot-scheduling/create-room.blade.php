        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('ot-scheduling.store-room') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="room_number" type="text" name="room_number" :value="old('room_number')" required class="block mt-1 w-full" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select id="type" name="type" required
                                    ...
                                    <option value="orthopedic" {{ old('type') == 'orthopedic' ? 'selected' : '' }}>Orthopedic</option>
                                    <option value="neurosurgery" {{ old('type') == 'neurosurgery' ? 'selected' : '' }}>Neurosurgery</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="floor" type="text" name="floor" :value="old('floor')" class="block mt-1 w-full" />
                                <x-input-error :messages="$errors->get('floor')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="building" :value="__('Building')" />
                                <x-text-input id="building" type="text" name="building" :value="old('building')" class="block mt-1 w-full" />
                        ...
                        <div>
                            ...
                            <x-text-input id="capacity" type="number" min="1" name="capacity" :value="old('capacity', 1)" required class="block mt-1 w-full" />
                        ...
                        <div>
                            ...
                            <textarea id="equipment" name="equipment" rows="3" 
                                      class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('equipment') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="3" 
                                      class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('notes') }}</textarea>
